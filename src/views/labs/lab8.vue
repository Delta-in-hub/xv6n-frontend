...
let lab8_1table = reactive([
  {
    name: "20194755",
    labitem: "lab8-1-symlink",
    score: 77
  },
  {
    name: "20187777",
...
lab8_1table = updateScoreTable(lab8_1table);

let lab8_2table = reactive([
  {
    name: "20194755",
    labitem: "lab8-2-largefile",
    score: 77
  },
  {
    name: "20187777",
...
lab8_2table = updateScoreTable(lab8_2table);

// - lab8-3-mmap
let lab8_3table = reactive([
  {
    name: "20194755",
    labitem: "lab8-3-mmap",
    score: 77
...
lab8_3table = updateScoreTable(lab8_3table);
</script>
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it1'"
                :values="['实验项目 LAB8-1-symlink']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab8_1table" :columns="columns">
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it2'"
                :values="['实验项目 LAB8-2-largefile']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab8_2table" :columns="columns">
            <template #operation="{ row }">
              <el-button type="primary" @click="handleClick(row)">
                下载学生实验代码
              </el-button>
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it3'"
                :values="['实验项目 LAB8-3-mmap']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab8_3table" :columns="columns">
            <template #operation="{ row }">
              <el-button type="primary" @click="handleClick(row)">
                下载学生实验代码
              </el-button>
