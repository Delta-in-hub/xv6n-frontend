...
let lab4_1table = reactive([
  {
    name: "20194755",
    labitem: "lab4-1-sched",
    score: 77
  },
  {
    name: "20187777",
...
lab4_1table = updateScoreTable(lab4_1table);

let lab4_2table = reactive([
  {
    name: "20194755",
    labitem: "lab4-2-mlfq",
    score: 77
...
lab4_2table = updateScoreTable(lab4_2table);
</script>
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it1'"
                :values="['实验项目 LAB4-1-sched']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab4_1table" :columns="columns">
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it2'"
                :values="['实验项目 LAB4-2-mlfq']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab4_2table" :columns="columns">
            <template #operation="{ row }">
              <el-button type="primary" @click="handleClick(row)">
                下载学生实验代码
              </el-button>
