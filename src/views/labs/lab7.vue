...
lab7_1table = updateScoreTable(lab7_1table);

let lab7_2table = reactive([
  {
    name: "20194755",
    labitem: "lab7-2-cow",
    score: 77
...
lab7_2table = updateScoreTable(lab7_2table);
</script>
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it1'"
                :values="['实验项目 LAB7-1-lazy']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab7_1table" :columns="columns">
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it2'"
                :values="['实验项目 LAB7-2-cow']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab7_2table" :columns="columns">
            <template #operation="{ row }">
              <el-button type="primary" @click="handleClick(row)">
                下载学生实验代码
              </el-button>
