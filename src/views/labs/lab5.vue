...
let lab5_1table = reactive([
  {
    name: "20194755",
    labitem: "lab5-1-exception",
    score: 77
  },
  {
    name: "20187777",
...
lab5_1table = updateScoreTable(lab5_1table);

let lab5_2table = reactive([
  {
    name: "20194755",
    labitem: "lab5-2-minigdb",
    score: 77
  },
  {
    name: "20187777",
...
lab5_2table = updateScoreTable(lab5_2table);
</script>
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it1'"
                :values="['实验项目 LAB5-1-exception']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab5_1table" :columns="columns">
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it2'"
                :values="['实验项目 LAB5-2-minigdb']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab5_2table" :columns="columns">
            <template #operation="{ row }">
              <el-button type="primary" @click="handleClick(row)">
                下载学生实验代码
              </el-button>
