...
let lab6_1table = reactive([
  {
    name: "20194755",
    labitem: "lab6-1-bestfit",
    score: 77
  },
  {
    name: "20187777",
...
lab6_1table = updateScoreTable(lab6_1table);

let lab6_2table = reactive([
  {
    name: "20194755",
    labitem: "lab6-2-buddy",
    score: 77
  },
  {
    name: "20187777",
...
lab6_2table = updateScoreTable(lab6_2table);

// - lab6-3-umalloc
let lab6_3table = reactive([
  {
    name: "20194755",
    labitem: "lab6-3-umalloc",
    score: 77
  },
  {
    name: "20187777",
...
lab6_3table = updateScoreTable(lab6_3table);
</script>
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it1'"
                :values="['实验项目 LAB6-1-bestfit']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab6_1table" :columns="columns">
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it2'"
                :values="['实验项目 LAB6-2-buddy']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab6_2table" :columns="columns">
            <template #operation="{ row }">
              <el-button type="primary" @click="handleClick(row)">
                下载学生实验代码
              </el-button>
        ...
        <el-card shadow="never" style="width: 100%; height: 100%">
          <template #header>
            ...
            >
              <TypeIt
                :className="'type-it3'"
                :values="['实验项目 LAB6-3-umalloc']"
                :cursor="false"
                :speed="120"
              />
            </a>
          </template>
          <pure-table :data="lab6_3table" :columns="columns">
            <template #operation="{ row }">
              <el-button type="primary" @click="handleClick(row)">
                下载学生实验代码
              </el-button>
